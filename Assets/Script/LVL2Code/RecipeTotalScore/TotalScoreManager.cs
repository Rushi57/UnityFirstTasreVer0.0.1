...
public class TotalScoreManager : MonoBehaviour
{
    ...
    public void CalculateFinalScore()
    {
        ...
        // 🚀 Assume each green = 3 points → calculate max possible score
        int maxMix = 3;   // adjust if mixing has multiple tries
        int maxCut = 3;   // adjust per ingredient
        int maxSimmer = 3; // adjust per simmer
        targetScore = maxMix + maxCut + maxSimmer;
